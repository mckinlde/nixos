{
  ...
  # generate with `ssh-keygen -t ed25519 -N "" -f ./id_ed25519 -C "dmei@hey.com"`
  sops.secrets.ssh = {
    owner = "dmei";
    path = "/home/dmei/.ssh/id_ed25519";
